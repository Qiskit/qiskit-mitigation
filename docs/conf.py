...
project = "Qiskit mitigation"
project_copyright = "2026, Qiskit addons team"
description = "Tools for handling errors during quantum computation."
author = "Qiskit addons team"
language = "en"
release = metadata_version("qiskit-mitigation")
...
modindex_common_prefix = ["qiskit_mitigation."]
...
def linkcode_resolve(domain, info):
    ...
    if module is None or "qiskit_mitigation" not in module_name:
        return None
    ...
    try:
        ...
        return None
    if full_file_name is None or "/qiskit_mitigation/" not in full_file_name:
        return None
    file_name = full_file_name.split("/qiskit_mitigation/")[-1]
    ...
    return f"https://github.com/Qiskit/qiskit-mitigation/tree/{GITHUB_BRANCH}/qiskit_mitigation/{file_name}{linespec}"
